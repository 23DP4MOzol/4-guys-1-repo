...
## Pasākumu plānotājs un brīvprātīgo koordinācija  
...
Galvenie ekrāni:
- Main Page (Sākumlapa)
- Products/Items List Page (Datu saraksta skats ar meklēšanu un filtrēšanu)

Uzdevumi:
- Navigācijas tabu/izvēlnes izveide
- Kopējā dizaina (UI) izstrāde
...
- User Profile / Add-Edit Form (Lietotāja profils vai datu pievienošanas/labošanas forma ar validāciju)

Uzdevumi:
- Formu izveide ar ievades datu validāciju
- E-pasta un paroles pārbaudes validācija
- Kļūdu paziņojumu izstrāde
- Apstiprinājuma paziņojumu izstrāde saskarnē

### 2. Backend & Datubāze
Komandas dalībnieki: Emīls Šīre un Markuss Auzāns

**Markuss Auzāns** - Datubāzes un servera puses arhitekts

Galvenie uzdevumi:
- Datubāzes struktūras izveide
- Datubāzes tabulu sakārtošana
- Pilnas CRUD (Create, Read, Update, Delete) funkcionalitātes izstrāde
- API punktu izstrāde izvēlētajā programmēšanas tehnoloģijā

**Emīls Šīre** — QA / Testētājs un dokumentācijas vadītājs

Galvenie uzdevumi:
- Programmsistēmas testēšana
- Kļūdu meklēšana un identificēšana
- GitHub repozitorija struktūras uzturēšana
- README.md faila izstrāde un uzturēšana
- Trello dēļa koordinēšana
- Scrum Master pienākumu veikšana